...
| Campo | Valor | Notas |
|-------|-------|-------|
| `displayName` | `Player Animation Core (1.0.21)` | Nombre visible: `display_name (version)` |
...
<p><strong>JAR</strong>: <code>player_animation_core-26.1.2-neoforge-1.0.21.jar</code></p>
```
