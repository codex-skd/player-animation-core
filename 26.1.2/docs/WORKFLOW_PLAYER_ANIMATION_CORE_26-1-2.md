...
|---|---|---|
| **snake_case** | `mod_id` en gradle.properties, assets/, packages Java | `player_animation_core` |
| **PascalCase** | Clases Java principales | `PlayerAnimationCore` |
| **camelCase** | Variables, métodos, config keys | `playerAnimationCore` |
| **Title Case** | Display name en README, CHANGELOG, docs, CurseForge | `Player Animation Core` |

### Ficheros de documentación

| Fichero | Formato | Ejemplo |
|---|---|---|
| WORKFLOW | `WORKFLOW_<MOD_ID>_<MC-VERSION>.md` | `WORKFLOW_PLAYER_ANIMATION_CORE_26-1-2.md` |
...
player_animation_core/       # Mod padre (una sola versión)
└── 26.1.2/                  # Único repositorio
    ├── .git/
    └── ...
```
...
| Ejemplo | Significado |
|---|---|
| `player_animation_core-26.1.2-neoforge-1.0.0.jar` | NeoForge 26.1.2, release 1.0.0 |
...
|---|---|---|
| 1.4.0 | 2026-07-23 | Versión actual. Organización en workspace: `<mod_id>/<mc-version>/` |
